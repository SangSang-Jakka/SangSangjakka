...
<body>
           ...
           <form method="POST" action="/sangsangjakka/board/freeboard/edit.do" >
            <div class="freeboardWrap">
                <div class="freeTitleContainer">
                    ...
                    <input type="text" name="subject" class="subject" value="${boardTitle}" required>
                </div>
                ...
                <div class="freeContentContainer">
                    ...
                    <textarea id="summernote" name="editordata" class="content" required>${boardContents}</textarea>
                </div>
            </div>
            ...
            <button type="submit" class="btnWrite" onclick="location.href='/sangsangjakka/board/freeboard/view.do' + ${freeSeq};" >
        ...
        <input type="hidden" name="seq" value="${freeSeq}">
        </form>
