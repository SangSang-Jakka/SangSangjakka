            ...
            <ul id="accordion-menu">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/sangsangjakka/admin/dashboard/blacklist/manage.do">차단회원 관리</a></li>
                    </ul>
                </li>
                <li class="dropdown">
                    <a href="javascript:;" class="dropdown-toggle">
                ...
                <li class="dropdown">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="/sangsangjakka/admin/dashboard/review/manage.do">리뷰 관리</a>
                        <li><a href="/sangsangjakka/admin/dashboard/comment/manage.do">댓글 관리</a></li>
                    </ul>
                </li>
