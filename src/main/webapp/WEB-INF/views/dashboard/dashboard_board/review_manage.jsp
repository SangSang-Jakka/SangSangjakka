...
<%--         <%@include file="/WEB-INF/views/dashboard/dashboard_template/banner.jsp"%> --%>
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4 center">리뷰 관리</h4>
					...
					<div class="pb-20">
						<table class="data-table table stripe hover nowrap" id="myTable">
							...
							<c:forEach var="review" items="${reviewList}">
								<tr>
									<td class="table-plus">${review.reviewSeq}</td>
									<td>${review.userNick}</td>
									<td>${review.reviewRegdate}</td>
									<td>${review.reviewContents}</td>
									<td>${review.reviewLikeCnt}</td>
									<td>${review.reviewReportCnt}</td>
									<td>
										<div class="dropdown">
	...
	<script src="/sangsangjakka/resources/vendors/scripts/review.js"></script>
