 ...
 */
 ...
 $('document').ready(function(){
    ...
    // 신고횟수 열 삽입
    var columnIndexToInsert = 5; // 삽입할 열의 인덱스 (0부터 시작)
    $('#myTable > thead > tr').children().eq(columnIndexToInsert).before('<th>신고횟수</th>');
    $('#myTable > tbody > tr').each(function() {
        $(this).children().eq(columnIndexToInsert).before('<td>0</td>');
    });
